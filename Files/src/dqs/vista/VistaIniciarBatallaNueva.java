            ...
            private JPanel crearPanelPersonaje(boolean esHeroe, int idx) {
                ...
                if (esHeroe) {
                    ...
                    if (h != null) {
                        ...
                        switch (h.getTipo()) {
                            case MAGO:
                                lblIcon.setIcon(cargarIcono("/dqs/vista/utilidades/Un mago de videojueg.png", 80, 80));
                                break;
                            case GUERRERO:
                                lblIcon.setIcon(cargarIcono("/dqs/vista/utilidades/Un guerrero de video.png", 80, 80));
                                break;
                            case PALADIN:
                                lblIcon.setIcon(cargarIcono("/dqs/vista/utilidades/Un paladín de videoj.png", 80, 80));
                                break;
                            case DRUIDA:
                                lblIcon.setIcon(cargarIcono("/dqs/vista/utilidades/Un druida teriantrop.png", 80, 80));
                                break;
                            default:
